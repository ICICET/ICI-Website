...
}$.ajax({crossDomain:true,dataType:"json",xhrFields:{withCredentials:true},url:"/bin/svc/ieeecommon/core/quote/v1/get-quote.dynamic-metanav.json",type:"POST",cache:false,data:"",success:function(h){if(h&&h.success){if(h.data!==null){$(".cart-items-count").html(h.data.cartItemCount);
